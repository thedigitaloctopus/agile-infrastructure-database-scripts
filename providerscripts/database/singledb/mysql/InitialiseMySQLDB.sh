...
GRANT CREATE USER ON *.* TO \"${DB_U}\"@'localhost' WITH GRANT OPTION;
GRANT CREATE USER ON *.* TO \"${DB_U}\"@'127.0.0.1' WITH GRANT OPTION;
GRANT CREATE USER ON *.* TO \"${DB_U}\"@\"${IP_MASK}\" WITH GRANT OPTION;
